...
class Hitter(object):
    ...
    def calculate_draftkings_points(self):
        mTotalPoints = 3 * (self.mGameH - self.mGame2b - self.mGame3b - self.mGameHr)
        mTotalPoints += 5*self.mGame2b
        mTotalPoints += 8*self.mGame3b
        mTotalPoints += 10*self.mGameHr
        mTotalPoints += 2*self.mGameRbi
        mTotalPoints += 2*self.mGameR
        mTotalPoints += 2*self.mGameBb
        mTotalPoints += 2*self.mGameHbp
        mTotalPoints += 5*self.mGameSb
        mTotalPoints -= 2*self.mGameCs
