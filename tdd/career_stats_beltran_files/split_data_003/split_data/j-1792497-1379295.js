...
var ft1792497 = {
	params:window.ftParams_1792497||"",
	confID:window.ftConfID_1792497||"0",
	guid:window.ftGUID_1792497||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1792497 && window.ftImp1792497.impID || '',
	pID:1792497,
	creativeID:"1379295",
	campaignID: "59002",
	exttrack:[],
	...
	width:"728",
	height:"90",
	altimg:"http://cdn.flashtalking.com/xre/179/1792497/1379295/image/1379295.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/3/59002;1792497;202;pixel;RocketFuelUSFTSection;RocketFuelTicketBooster728x90AV/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/3/59002;1792497;1379295;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.bso.org/Performance/Detail/79089?utm_source=norbella&utm_medium=display&utm_campaign-pops0507",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?65437080-1792497;1379295;",
	divID:"ftdiv1792497",
	altimgID:"ftalt1792497",
    imgID: "ftImg1792497",
    frameID:"ftframe1792497",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/3/59002;1792497;207;guid;RocketFuelUSFTSection;RocketFuelTicketBooster728x90AV/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1792497[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1792497"],
        ["ftcfid","ftConfID_1792497"],
        ["ftcustom","ftCustom_1792497"],
        ["fttime","ftTimestamp_1792497"],
        ["ftsection","ftSection_1792497"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1792497', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1792497'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1792497 && window.ftImp1792497.jsAppend) {
