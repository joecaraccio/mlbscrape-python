...
function init() {
	...
	//var line_3_6			= document.getElementById(	"line_3_6"				);
	...
	function _startAnimation() {
		...
		//.from(	line_3_5 	,	_enter,		{	x:xHide, ease:_enterEase 	},"line_3+=.500"		)
		//.from(	line_3_6 	,	_enter,		{	x:xHide, ease:_enterEase 	},"line_3+=.625"		)
