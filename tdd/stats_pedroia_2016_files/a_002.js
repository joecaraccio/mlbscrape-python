...
Math.floor(1E5*Math.random()+1)},getDateNow:function(){return!Date.now?(new Date).valueOf():Date.now()},getElementHTML:function(a){var b=document.createElement("div");b.appendChild(a.cloneNode(!0));return b.innerHTML},buildQueryString:function(a){var b=[];QSI.util.forOwn(a,function(c,d){b.push(encodeURIComponent(d)+"="+encodeURIComponent(a[d]))});return b.join("&")},waitForFocus:function(){var a=QSI.util.Deferred();document.hasFocus()?a.resolve():QSI.util.observe(window,"focus",function(){a.resolve()});
return a.promise()},truncateString:function(a,b){return null===a||void 0===a?null:a.length<=b?a:a.slice(0,b)+"..."},ScriptLoader:function(a){var b=document.getElementsByTagName("script")[0];this.getScriptURL=function(b){return a+b};this.load=function(a,d){if(!(void 0===a||null===a)){var e="";if(d){var g=[];QSI.util.forOwn(d,function(a,b){g.push(b+"="+d[b])});e="?"+g.join("&")}var f=QSI.util.Deferred(),h,e=this.getScriptURL(a)+e;h=QSI.util.build("script",{src:e,"data-qsimodule":"script"});QSI.util.observe(h,
"load",function(){f.resolve()});QSI.util.observe(h,"readystatechange",function(){("loaded"===h.readyState||"complete"===h.readyState)&&f.resolve()});b.parentNode.insertBefore(h,b);return f.promise()}}},generateRandomID:function(a){return a+"_"+Math.round(1E8*Math.random())},build:function(a,b,c){var d=document.createElement(a);if(b){var e=this;QSI.util.forOwn(b,function(a,c){switch(c){case "style":e.setStyle(d,b[c]);break;case "className":d.className=b[c];break;case "id":d.id=b[c];break;default:d.setAttribute(c,
b[c])}})}if(c)if(QSI.util.isString(c))"style"==a&&d.styleSheet?d.styleSheet.cssText=c:d.appendChild(document.createTextNode(String(c)));else if(QSI.util.isArray(c)){a=0;for(var g=c.length;a<g;a++){var f=c[a];"string"==typeof f||"number"==typeof f?d.appendChild(document.createTextNode(String(f))):f&&f.nodeType&&d.appendChild(f)}}return d},showTrialIcon:function(){if(!this.trialIcon){var a=this.build("div",{},[this.build("img",{src:QSI.global.imagePath+"/siteintercept/logo.png"})]);this.trialIcon=a;
QSI.util.setStyle(a,{opacity:0.5,padding:"20px",bottom:"0",right:"0",position:"fixed"});document.body.appendChild(a)}},createArrayFromArguments:function(a){return!a?[]:Array.prototype.slice.call(a)},createArrayFromIterable:function(a){for(var b=a.length||0,c=Array(b);b--;)c[b]=a[b];return c},sendHttpRequest:function(a){var b=new XMLHttpRequest;b.open(a.type,a.url);a.timeout&&(b.timeout=a.timeout,a.timeoutCallback&&(b.ontimeout=a.timeoutCallback));for(var c in a.header)b.setRequestHeader(c,a.header[c]);
a.includeCookies&&(b.withCredentials=!0,b.setRequestHeader("Access-Control-Allow-Credentials","true"));b.onreadystatechange=function(){4==b.readyState&&(200==b.status&&a.successCallback?a.successCallback(b):a.errorCallback&&a.errorCallback(b))};b.send(a.data)},Class:function(){function a(){try{this.initialize&&this.initialize.apply(this,arguments)}catch(a){QSI.dbg.e(a)}}function b(b){QSI.util.forOwn(b,function(c,d){a.prototype[d]=b[d]})}for(var c=QSI.util.createArrayFromArguments(arguments),d=0,e=
c.length;d<e;d++)b(c[d]);return a},Creative:function(){var a=this.Class.apply(this,arguments);a.prototype.globalInitialize=function(a){this.displayed=QSI.util.Deferred();this.willShow=QSI.util.Deferred();this.cookiesEnabled=QSI.util.Deferred();this.preventRepeatedDisplay=QSI.util.Deferred();this.localStorageEnabled=QSI.util.Deferred();this.options=a||{};this.id=this.options.id;this.type=this.options.type;this.displayOptions=this.options.displayOptions||{};this.displayOptions.displayed=this.displayed.promise();
this.interceptDisplayOptions=this.options.interceptDisplayOptions||{};this.actionOptions=this.options.actionOptions||{};var c;this.actionOptions.actionSetJavaScriptBeforeDisplay&&this.shouldShow()&&(c=this.actionOptions.actionSetJavaScriptBeforeDisplay,this.evalJS(c));if(this.actionOptions.actionSetJavaScript){var d=this;c=this.actionOptions.actionSetJavaScript;this.displayed.done(function(){d.evalJS(c)})}this.actionOptions.actionSetEvents&&QSI.util.processElementEvents(this.actionOptions.actionSetEvents,
null,this);this.getType()!=QSI.util.creativeTypes.POP_UNDER&&this.killPopUnder();QSI.util.addStatsImage()};a.prototype.evalJS=function(a){try{eval(a)}catch(c){QSI.dbg.c("Error During Eval JavaScript "+c)}};a.prototype.getType=function(){return this.type};a.prototype.getTarget=function(a){var c=this.options.targetURL;if(a=QSI.EmbeddedData.getEmbeddedData(this.id,a))a=encodeURIComponent(a),"Internet Explorer"==QSI.Browser.name&&9>QSI.Browser.version&&(a=a.substring(0,2050-c.length)),c+="&Q_ED="+a;return c};
a.prototype.getTargetHelper=function(a){var c=this;return function(){return c.getTarget(a)}};a.prototype.resetStyles=function(){if(this.options.resetStyle){var a=QSI.util.build("style",{type:"text/css"});if(a.styleSheet)document.getElementsByTagName("head")[0].appendChild(a),a.styleSheet.cssText=this.options.resetStyle;else{document.body.appendChild(a);var c=document.createTextNode(this.options.resetStyle);a.appendChild(c)}}};a.prototype.killPopUnder=function(){try{var a="QSIPopUnder_"+this.id;if(QSI.cookie.get(a)){var c=
QSI.util.openWin("",a);c&&c.w&&(c.w.popunderDead=!0);c.close();QSI.cookie.erase(a)}}catch(d){}};a.prototype.shouldShow=function(){var a=!0;this.interceptDisplayOptions.hideOnCookiesDisabled&&(QSI.cookie.areCookiesEnabled()?this.cookiesEnabled.resolve():(this.cookiesEnabled.reject(),a=!1));this.interceptDisplayOptions.hideOnLocalStorageDisabled&&(QSI.localStorage.isLocalStorageEnabled()?this.localStorageEnabled.resolve():(this.localStorageEnabled.reject(),a=!1));this.shouldPreventRepeatedDisplay()?
(this.preventRepeatedDisplay.resolve(),a=!1):this.preventRepeatedDisplay.reject();if(a)return this.willShow.resolve(),!0;this.willShow.reject();return!1};a.prototype.shouldPreventRepeatedDisplay=function(){var a=!1;if(0!=this.interceptDisplayOptions.noshow)try{null!==QSI.cookie.get(this.id+"_intercept")?(a=!0,QSI.cookie.erase(this.id+"_intercept")):null!==QSI.cookie.get("QSI_"+this.id+"_intercept")&&(a=!0)}catch(c){QSI.dbg.e(c)}else QSI.cookie.erase("QSI_"+this.id+"_intercept");return a};a.prototype.setPreventRepeatedDisplayCookie=
function(){if(this.interceptDisplayOptions&&this.interceptDisplayOptions.noshow&&0!=this.interceptDisplayOptions.noshow&&null===QSI.cookie.get("QSI_"+this.id+"_intercept"))try{QSI.cookie.set("QSI_"+this.id+"_intercept",!0,this.interceptDisplayOptions.noshow,this.interceptDisplayOptions.cookieDomain,{force:!0})}catch(a){QSI.dbg.e(a)}};a.prototype.impress=function(){QSI.util.impress(this.options.impressionURL);this.setPreventRepeatedDisplayCookie()};a.prototype.close||(a.prototype.close=function(){});
a.prototype.remove||(a.prototype.remove=a.prototype.close);return a},evalJSON:function(a){try{return eval("("+a+")")}catch(b){QSI.dbg.e(b)}},isString:function(a){return"string"==typeof a},isArray:function(a){return"object"==typeof a&&a instanceof Array},isFunction:function(a){return"function"===typeof a||!1},isIE8:function(){return this.isIE(8)},isIE:function(a){return"Internet Explorer"!=QSI.Browser.name?!1:!a?!0:a==QSI.Browser.version},isChrome:function(){return"Chrome"===QSI.Browser.name},isOpera:function(){return"Opera"===
QSI.Browser.name},isFF:function(){return"Firefox"===QSI.Browser.name},removePx:function(a){a=a||"";var b=a.indexOf("px");0<b&&(a=a.substr(0,b));return a},getDimensions:function(a){var b=!0;if(!a.parentNode||!a.parentNode.tagName)document.body.appendChild(a),b=!1;var c=a.style.display||this.getComputedStyle(a).display;if("none"!=c&&null!==c)return c={width:a.offsetWidth,height:a.offsetHeight},b||a.parentNode.removeChild(a),c;var c=a.style,d=c.visibility,e=c.position,g=c.display;c.visibility="hidden";
c.position="absolute";c.display="block";var f=a.clientWidth,h=a.clientHeight;c.display=g;c.position=e;c.visibility=d;b||a.parentNode.removeChild(a);return{width:f,height:h}},convertPercentToPixel:function(a,b){return Math.round(a/100*b)},convertPixelToPercent:function(a,b){return Math.round(100*(a/b))},cumulativeOffset:function(a){var b,c={top:0,left:0};if(b=a&&a.ownerDocument)return b=b.documentElement,"undefined"!==typeof a.getBoundingClientRect&&(c=a.getBoundingClientRect()),{top:c.top+(window.pageYOffset||
b.scrollTop)-(b.clientTop||0),left:c.left+(window.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}},getTimeout:function(a){var b=QSI.util.Deferred();a=1E3*parseFloat(a);window.setTimeout(function(){b.resolve()},a);return b.promise()},getComputedStyle:function(a){return a.currentStyle||window.getComputedStyle(a,null)},getWindowSize:function(a){var b=a||window;a=this.getPageSize(a);return{width:b.outerWidth||a.width,height:b.outerHeight||a.height}},getPageSize:function(a){a=a||window;var b=a.document.documentElement||
{};return{width:a.innerWidth||b.clientWidth,height:a.innerHeight||b.clientHeight}},getScrollOffsets:function(){var a=window,b=a.document.documentElement;return{left:"pageXOffset"in a?a.pageXOffset:b.scrollLeft,top:"pageYOffset"in a?a.pageYOffset:b.scrollTop}},startScrolling:function(){if("Internet Explorer"==QSI.Browser.name&&8>QSI.Browser.version){var a=document.getElementsByTagName("html")[0];QSI.util.setStyle(a,{overflow:this.originalDocumentOverflow})}else QSI.util.setStyle(document.body,{overflow:this.originalDocumentOverflow});
document.ontouchmove=QSI.touchScrollEvent;QSI.touchScrollEvent=null},stopScrolling:function(){if("Internet Explorer"==QSI.Browser.name&&8>QSI.Browser.version){var a=document.getElementsByTagName("html")[0];this.originalDocumentOverflow=this.originalDocumentOverflow||this.getStyle(a,"overflow");QSI.util.setStyle(a,{overflow:"hidden"})}else this.originalDocumentOverflow=this.originalDocumentOverflow||this.getStyle(document.body,"overflow"),QSI.util.setStyle(document.body,{overflow:"hidden"});document.ontouchmove&&
(QSI.touchScrollEvent=document.ontouchmove);document.ontouchmove=function(a){a.preventDefault()}},hasScrollbars:function(){var a=document.documentElement;return"Internet Explorer"===QSI.Browser.name&&8>QSI.Browser.version?!0:"Internet Explorer"===QSI.Browser.name&&9>QSI.Browser.version?6<a.offsetWidth-a.scrollWidth:a.scrollWidth<window.innerWidth},pageMode:function(){return"CSS1Compat"==document.compatMode?"Standards":"Quirks"},isFixed:function(){return!("Internet Explorer"==QSI.Browser.name&&"Standards"!=
this.pageMode())},openWin:function(a,b,c){var d=[];c=c||{};QSI.util.forOwn(c,function(a,b){d.push(b+"="+c[b])});d=d.join(",");return window.open(a,b,d)},impress:function(a){a&&(a=QSI.util.build("img",{src:a+"&r="+(new Date).getTime(),style:{display:"none"}}),document.body.appendChild(a))},getQueryParam:function(a,b){b=b.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var c=RegExp("[\\?&]"+b+"=([^&#]*)").exec(a);return null===c?"":c[1]},capFirst:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},
observe:function(a,b,c){this.obs=this.obs||[];a&&(this.obs.push({el:a,e:b,f:c}),a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent?a.attachEvent("on"+b,c):a["on"+this.capFirst(b)]&&(a["on"+this.capFirst(b)]=c))},stopObserving:function(a,b,c){a.removeEventListener?a.removeEventListener(b,c,!1):a.detachEvent?a.detachEvent("on"+b,c):a["on"+this.capFirst(b)]&&(a["on"+this.capFirst(b)]=null)},removeObservers:function(){var a=this;this.each(this.obs||[],function(b){a.stopObserving(b.el,b.e,b.f)})},
hasReachedScrollPosition:function(a){var b=this.getScrollOffsets().top,c=this.getPageSize().height;return b+c>=document.body.scrollHeight*(a/100)?!0:!1},remove:function(a){a&&a.parentNode&&a.parentNode.removeChild(a)},removeAllByQuery:function(a,b){var c=a.querySelectorAll(b);Array.prototype.forEach.call(c,function(a){QSI.util.remove(a)})},buildWidget:function(a,b){var c="build"+a+"Widget";return this[c]?this[c](b):""},buildCCDWidget:function(a){a=a||{};if(a.close&&0<parseInt(a.close,10)){var b=a.close,
c=this.getTempID(),d=this.build("span",{id:c},b+""),d=this.build("span",{},[d]),e=this,g=function(){var d=function(){if(!(0>=b)){var a=e.$(c);a&&(a.innerHTML=--b+"");setTimeout(d,1E3)}};a.delay&&0<a.delay?setTimeout(function(){setTimeout(d,1E3)},1E3*a.delay):setTimeout(d,1E3)};a.displayed?a.displayed.done(function(){g()}):g();return this.getElementHTML(d)}return""},positionFixed:function(a,b,c){a.style.position="absolute";var d=0,e=this.getPageSize().height,g=document.body.scrollHeight,f=QSI.util.getScrollOffsets().top,
h;0<f&&("auto"==c?(a.style.top=f+parseInt(b,10)+"px",a.style.bottom=c):"auto"==b&&(a.style.bottom=f+e-parseInt(b,10)+"px",a.style.top=b));"string"==typeof b&&-1<b.indexOf("px")&&(b=parseInt(b,10));"string"==typeof c&&-1<c.indexOf("px")&&(c=parseInt(c,10));var j=function(){clearTimeout(h);h=setTimeout(function(){var h=QSI.util.getScrollOffsets().top;if(!(0>h||h+e>g)){var f=h+b,m=f-d,l=0<=m?20:-20;10>Math.abs(m)&&(l=m);var k;d=f;"auto"==c?k=setInterval(function(){var b=parseInt(a.style.top,10)+l;a.style.top=
b+"px";a.style.bottom=c;0<l?b>=f&&(clearInterval(k),QSI.util.observe(window,"scroll",j)):b<=f&&(clearInterval(k),QSI.util.observe(window,"scroll",j));QSI.util.observe(window,"scroll",j)},15):"auto"==b&&(k=setInterval(function(){var d=parseInt(a.style.bottom,10)+l;a.style.bottom=h+e-c+"px";a.style.top=b;a.style.bottom=d+"px";0<l?d>=f&&(clearInterval(k),QSI.util.observe(window,"scroll",j)):d<=f&&(clearInterval(k),QSI.util.observe(window,"scroll",j));QSI.util.observe(window,"scroll",j)},15))}},60)};
QSI.util.observe(window,"scroll",j)},each:function(a,b){var c=a.length;if(c)for(var d=0;d<c;d++)b(a[d],d)},forOwn:function(a,b){if(a&&a instanceof Object&&this.isFunction(b))for(var c in a)a.hasOwnProperty(c)&&b(a[c],c,a)},filter:function(a,b){try{if(a.filter&&this.isFunction(a.filter))return a.filter(b)}catch(c){}var d=a.length,e=[];if(d)for(var g=0;g<d;g++)b(a[g])&&e.push(a[g]);return e},Deferred:function(){var a={},b="pending",c=[],d=[],e=[],g=[],f={state:function(){return b},then:function(a,b){this.done(a).fail(b);
return this},done:function(a){"pending"==b?e.push(a):"resolved"==b&&a.apply(this,c);return this},fail:function(a){"pending"==b?g.push(a):"rejected"==b&&a.apply(this,d);return this},promise:function(){return f}};QSI.util.forOwn(f,function(b,c){a[c]=f[c]});a.resolve=function(){if("pending"==b){b="resolved";var a=QSI.util.createArrayFromArguments(arguments);c=a;var d=this;QSI.util.each(e,function(b){b.apply(d,a)})}};a.reject=function(){if("pending"==b){b="rejected";var a=QSI.util.createArrayFromArguments(arguments);
d=a;var c=this;QSI.util.each(g,function(b){b.apply(c,a)})}};return a},when:function(a){var b=QSI.util.createArrayFromArguments(arguments),c=b.length,d=c,e=1===d?a:QSI.util.Deferred(),g=function(a,b){return function(c){b[a]=1<arguments.length?c:QSI.util.createArrayFromArguments(arguments);--d||e.resolve(b)}};if(1<c)for(var f=0;f<c;f++)b[f]&&b[f].promise?b[f].promise().done(g(f,b)).fail(e.reject):d--;1>d&&e.resolve(b);return e.promise()},moveToBackground:function(){("Firefox"===QSI.Browser.name||"Internet Explorer"===
...
b))}},getDocDimension:function(a){var b=document,c=b.documentElement;return Math.max(b.body["scroll"+a],c["scroll"+a],b.body["offset"+a],c["offset"+a],c["client"+a])},getDocWidth:function(){return this.getDocDimension("Width")},getDocHeight:function(){return this.getDocDimension("Height")},getScroll:function(){var a=this.getScrollOffsets();return{width:this.getDocWidth(),height:this.getDocHeight(),left:a.left,top:a.top}},fireGoogleEventBeacon:function(a,b,c){0>a.search(/^UA-\d+-\d{1,2}$/)?QSI.dbg.c("Google Anylytics Account number is incorrect "+
a):window.GoogleAnalyticsObject?this.googleEventAnyalytics(window.GoogleAnalyticsObject,a,b,c):this.googleEventGA(a,b,c)},googleEventGA:function(a,b,c){var d="SITracker"+this.getTempID(),e=window._gaq||[];e.push([d+"._setAccount",a]);e.push([d+"._trackEvent",b,c])},googleEventAnyalytics:function(a,b,c,d){var e="SITracker"+this.getTempID();window[a]("create",b,{name:e});window[a](e+".send","event",c,d)},evalJS:function(a){return function(){try{eval(a)}catch(b){QSI.dbg.c("Error During Eval JavaScript "+
b)}}},processElementEvents:function(a,b,c){if(a&&!(0>=a.length||0>=a[0].length)){c=new QSI.ActionModule(c);a=a[0];for(var d=0,e=a.length;d<e;d++)c.add(a[d]);c.addToElement(b)}}};
...
window._qsie = QSI.API.Events;
	...
	var QSIDependencyResolver = new QSI.DependencyResolver({
		...
		baseURL:'http://siteintercept.qualtrics.com/WRSiteInterceptEngine/?Q_SIID=SI_3CWPKrI10k7ANBX&Q_LOC=http%3A%2F%2Fwww.baseball-reference.com%2Fplayers%2Fsplit.cgi%3Fid%3Dpedrodu01%26year%3D2016%26t%3Db',
		debug:false,
