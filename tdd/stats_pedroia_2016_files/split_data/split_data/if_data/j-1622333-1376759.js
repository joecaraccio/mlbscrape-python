...
var ft1622333 = {
	params:window.ftParams_1622333||"",
	confID:window.ftConfID_1622333||"0",
	guid:window.ftGUID_1622333||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1622333 && window.ftImp1622333.impID || '',
	pID:1622333,
	creativeID:"1376759",
	campaignID: "52293",
	exttrack:[],
	...
	width:"300",
	height:"250",
	altimg:"http://cdn.flashtalking.com/xre/162/1622333/1376759/image/1376759.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/3/52293;1622333;202;pixel;Varick;BSOWinterDisplayRetargeting300x250/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/3/52293;1622333;1376759;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.bso.org/brands/bso/features/2015-16-bso-season/apr-21-23-dutilleux-rachmaninoff-tchaikovsky-debussy-ravel.aspx?utm_source=norbella&utm_medium=display&utm_campaign-bso0421",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?65131622-1622333;1376759;",
	divID:"ftdiv1622333",
	altimgID:"ftalt1622333",
    imgID: "ftImg1622333",
    frameID:"ftframe1622333",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/3/52293;1622333;207;guid;Varick;BSOWinterDisplayRetargeting300x250/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1622333[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1622333"],
        ["ftcfid","ftConfID_1622333"],
        ["ftcustom","ftCustom_1622333"],
        ["fttime","ftTimestamp_1622333"],
        ["ftsection","ftSection_1622333"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1622333', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1622333'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1622333 && window.ftImp1622333.jsAppend) {
